package com.sesame.medecinservice.service;
...
public class KeycloakService {
    ...
    private String getAdminToken() {
        // Use Service Account from backend-service client for secure access
        ...
        map.add("client_secret", "backend-secret"); // Should be externalized in prop
        ...
        try {
            ...
            System.err.println("Error fetching admin token: " + e.getMessage());
